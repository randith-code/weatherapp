...
export const Login = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            if(values.email === 'sample@gmail.com' && values.password === 'p@ssw0rd'){
                navigate('/home')
            }
            else{
    ...
    return(
        <div className="w-screen h-screen md:h-screen md:w-3/5 grid place-items-center">
            <div className=' w-8/12  md:w-6/12 h-fit flex flex-col justify-around'>
                ...
                <p className='text-sm border-2 border-red-600 p-1 my-1 text-red-600 rounded-lg grid place-content-center' >{alert}</p>
                ...
                <form onSubmit={formik.handleSubmit} className='flex flex-col' action="">
