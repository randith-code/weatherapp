  ...
  return (
    <div className="w-screen h-fit">
      ...
      {weatherList.length !== 0 ? (
        <div className="w-screen h-fit flex flex-wrap justify-center">
          ...
          {seemore ? (
            weatherList.slice(21).map((record, i) => {
              const wdata = {
                temp: record.main.temp,
                date: record.dt_txt,
                weather: record.weather[0].main,
          ...
          <span className="w-5/6 h-fit flex justify-end">
            <p
              ...
              className="text-purple-main border-purple-main border-2 text-xs p-1 rounded-3xl cursor-pointer"
            >
